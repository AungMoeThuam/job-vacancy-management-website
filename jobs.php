    ...
    <main class="jobs">
        ...
        <section class="job-detail-list">
            <section class="job-detail" id="data-quality-manager">
                ...
                <a class="reference"
                    href="https://www.jobstreet.com.my/data-analyst-jobs?jobId=78987181&type=standout">Reference</a>
            ...
            <section class="job-detail" id="cloud-architect">
                ...
                <a class="reference"
                    href="https://www.jobstreet.com.my/cloud-architect-jobs?jobId=78747653&type=standout">Reference</a>
                <a href="./apply.html"><button>Apply Now</button></a>
            </section>
            ...
            <section class="job-detail" id="mobile-front-end-developer">
                ...
                <a class="reference"
                    href="https://www.jobstreet.com.my/mobile-front-end-developer-jobs?jobId=78428091&type=standout">Reference</a>
                <a href="./apply.html"><button>Apply Now</button></a>
            </section>
            ...
            <section class="job-detail" id="full-stack-developer">
                ...
                <a class="reference"
                    href="https://www.jobstreet.com.my/full-stack-developer-jobs?jobId=78914621&type=standout">Reference</a>
                <a href="./apply.html"><button>Apply Now</button></a>
            </section>
        </section>
        <aside class="job-list">
            <section class="job-search">
                <label for="search">
                    Job Search
                    <input type="search" name="search" id="search" placeholder="enter job titile or keyword..." />
                </label>
            </section>
